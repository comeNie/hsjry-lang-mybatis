 ...
 *
 * @author jinyn22648
 * @version $$Id: BaseInsertWithBlobsProvider.java, v 0.1 2018/1/29 上午9:47 jinyn22648 Exp $$
 */
public class BaseInsertWithBlobsProvider extends MapperTemplate {

    public BaseInsertWithBlobsProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
